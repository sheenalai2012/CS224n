...
class BertSentimentClassifier(torch.nn.Module):
    ...
    def __init__(self, config):
        ...
        ### TODO
        # config keys: num_labels, hidden_size, data_dir, fine_tune_mode
        self.dropout = torch.nn.Dropout(0.1)
        self.lin_proj = torch.nn.Linear(config.hidden_size, self.num_labels)
    ...
    def forward(self, input_ids, attention_mask):
        ...
        last_hidden_state = map['last_hidden_state']
