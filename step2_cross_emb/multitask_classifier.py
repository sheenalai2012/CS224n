...
def train_multitask(args):
    ...
    for epoch in range(15):
        ...
        for batch in tqdm(para_train_dataloader, desc=f'train-{epoch}', disable=TQDM_DISABLE):
                ...
                optimizer.zero_grad()
                logits, embed = model.predict_paraphrase(b_ids_1, b_mask_1, b_ids_2, b_mask_2, get_embed=True)
                ...
                loss = F.binary_cross_entropy(logits, torch.unsqueeze(b_labels, 1), reduction='sum') / args.batch_size
                loss += reg_loss
        ...
        curr_score = utils.calc_score(sentiment_dev_accuracy, paraphrase_dev_accuracy, sts_dev_corr)
